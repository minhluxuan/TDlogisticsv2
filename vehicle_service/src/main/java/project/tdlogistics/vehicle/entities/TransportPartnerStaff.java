...
public class TransportPartnerStaff {
    ...
    public TransportPartnerStaff() {
    }

    public TransportPartnerStaff(String agencyId, String partnerId, String staffId, String fullname,
