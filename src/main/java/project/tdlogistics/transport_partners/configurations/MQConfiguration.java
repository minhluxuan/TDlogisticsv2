...
public class MQConfiguration {
    ...
    public Queue partnerQueue() {
        return new Queue("rpc.partner", true);
    }

    @Bean
    Binding partnerBinding(Queue partnerQueue, DirectExchange exchange) {
        return BindingBuilder.bind(partnerQueue).to(exchange).with("rpc.partner");
    }
