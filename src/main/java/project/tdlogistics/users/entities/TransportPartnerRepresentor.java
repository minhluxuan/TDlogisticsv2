...
public class TransportPartnerRepresentor {
    ...
    public TransportPartnerRepresentor(String agencyId, String transportPartnerId, String staffId, String fullname,
    ...
    public String toString() {
        return "TransportPartnerRepresentor [agencyId=" + agencyId + ", transportPartnerId=" + transportPartnerId
